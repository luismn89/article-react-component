...
const ShareContainer = styled.div`
  ...
  @media (min-width: 940px) {
    width: 220px;
    right: calc((-220px / 2) + 45px);
    bottom: 90px;
    box-shadow: 0 7px 4px ${colors.lightGrayishBlue};
    padding: 15px 25px;
    border-radius: 1em;
    ...
    &::after {
      ...
      position: absolute;
      pointer-events: none;
      box-shadow: 4px 4px 4px ${colors.lightGrayishBlue};
      border-bottom-color: ${colors.veryDarkGrayishBlue};
      border-right-color: ${colors.veryDarkGrayishBlue};
      border-width: 10px;
...
const SharePopup = ({ shareActive }) => {
  return (
    <ShareContainer open={shareActive}>
      <p>share</p>
